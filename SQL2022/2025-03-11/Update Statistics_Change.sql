...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks].sys.stats S CROSS APPLY [AdventureWorks].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000002_5AEE82B9' AND OBJECT_NAME(S.OBJECT_ID) = 'EmailAddress' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks].[Person].[EmailAddress] [_WA_Sys_00000002_5AEE82B9] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000002_5AEE82B9] on [AdventureWorks].[Person].[EmailAddress] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000002_5AEE82B9] on [AdventureWorks].[Person].[EmailAddress] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks].sys.stats S CROSS APPLY [AdventureWorks].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000004_5AEE82B9' AND OBJECT_NAME(S.OBJECT_ID) = 'EmailAddress' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks].[Person].[EmailAddress] [_WA_Sys_00000004_5AEE82B9] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000004_5AEE82B9] on [AdventureWorks].[Person].[EmailAddress] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000004_5AEE82B9] on [AdventureWorks].[Person].[EmailAddress] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks].sys.stats S CROSS APPLY [AdventureWorks].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000005_5AEE82B9' AND OBJECT_NAME(S.OBJECT_ID) = 'EmailAddress' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks].[Person].[EmailAddress] [_WA_Sys_00000005_5AEE82B9] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000005_5AEE82B9] on [AdventureWorks].[Person].[EmailAddress] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000005_5AEE82B9] on [AdventureWorks].[Person].[EmailAddress] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks].sys.stats S CROSS APPLY [AdventureWorks].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000002_7A672E12' AND OBJECT_NAME(S.OBJECT_ID) = 'Password' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks].[Person].[Password] [_WA_Sys_00000002_7A672E12] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000002_7A672E12] on [AdventureWorks].[Person].[Password] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000002_7A672E12] on [AdventureWorks].[Person].[Password] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks].sys.stats S CROSS APPLY [AdventureWorks].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000003_7A672E12' AND OBJECT_NAME(S.OBJECT_ID) = 'Password' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks].[Person].[Password] [_WA_Sys_00000003_7A672E12] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000003_7A672E12] on [AdventureWorks].[Person].[Password] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000003_7A672E12] on [AdventureWorks].[Person].[Password] cannot be updated.';			
	END CATCH;
END
