...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [NewDB20241029].sys.stats S CROSS APPLY [NewDB20241029].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'AK_Person_rowguid' AND OBJECT_NAME(S.OBJECT_ID) = 'Person' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [NewDB20241029].[Person].[Person] [AK_Person_rowguid] WITH FULLSCAN ;
		END
		PRINT '[AK_Person_rowguid] on [NewDB20241029].[Person].[Person] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[AK_Person_rowguid] on [NewDB20241029].[Person].[Person] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [NewDB20241029].sys.stats S CROSS APPLY [NewDB20241029].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'IX_Person_LastName_FirstName_MiddleName' AND OBJECT_NAME(S.OBJECT_ID) = 'Person' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [NewDB20241029].[Person].[Person] [IX_Person_LastName_FirstName_MiddleName] WITH FULLSCAN ;
		END
		PRINT '[IX_Person_LastName_FirstName_MiddleName] on [NewDB20241029].[Person].[Person] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[IX_Person_LastName_FirstName_MiddleName] on [NewDB20241029].[Person].[Person] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [NewDB20241029].sys.stats S CROSS APPLY [NewDB20241029].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'PK_Person_BusinessEntityID' AND OBJECT_NAME(S.OBJECT_ID) = 'Person' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [NewDB20241029].[Person].[Person] [PK_Person_BusinessEntityID] WITH FULLSCAN ;
		END
		PRINT '[PK_Person_BusinessEntityID] on [NewDB20241029].[Person].[Person] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[PK_Person_BusinessEntityID] on [NewDB20241029].[Person].[Person] cannot be updated.';			
	END CATCH;
END
