...
BEGIN TRY
	...
	BEGIN
		...
		BEGIN
			...
			END
			INSERT INTO #results
			EXEC master..xp_cmdshell 'copy "C:\Program Files\Microsoft SQL Server\MSSQL16.SQL2022\MSSQL\DATA\AdventureWorks_log_2403191209.ldf" "G:\SQL2022\SSDE_LOG\AdventureWorks_log_2403191209.ldf" /Z /Y ';
			IF EXISTS(SELECT * FROM #results WHERE result LIKE '%1 file(s) copied.%')
			BEGIN
				ALTER DATABASE [AdvDest20240317] MODIFY FILE (NAME='AdventureWorks2022_log' , FILENAME='G:\SQL2022\SSDE_LOG\AdventureWorks_log_2403191209.ldf');
				ALTER DATABASE [AdvDest20240317] SET ONLINE;
...
BEGIN TRY
	...
	BEGIN
		...
		BEGIN
			...
			END
			INSERT INTO #results
			EXEC master..xp_cmdshell 'copy "C:\Program Files\Microsoft SQL Server\MSSQL16.SQL2022\MSSQL\DATA\AdventureWorks_Log_2401150905_2403191209.ldf" "G:\SQL2022\SSDE_LOG\AdventureWorks_Log_2401150905_2403191209.ldf" /Z /Y ';
			IF EXISTS(SELECT * FROM #results WHERE result LIKE '%1 file(s) copied.%')
			BEGIN
				ALTER DATABASE [Advnew2022Moved] MODIFY FILE (NAME='AdventureWorks2016_Log' , FILENAME='G:\SQL2022\SSDE_LOG\AdventureWorks_Log_2401150905_2403191209.ldf');
				ALTER DATABASE [Advnew2022Moved] SET ONLINE;
...
BEGIN TRY
	...
	BEGIN
		...
		BEGIN
			...
			END
			INSERT INTO #results
			EXEC master..xp_cmdshell 'copy "C:\Program Files\Microsoft SQL Server\MSSQL16.SQL2022\MSSQL\DATA\AdventureWorks_log_2404110239.ldf" "G:\SQL2022\SSDE_LOG\AdventureWorks_log_2404110239.ldf" /Z /Y ';
			IF EXISTS(SELECT * FROM #results WHERE result LIKE '%1 file(s) copied.%')
			BEGIN
				ALTER DATABASE [Demo20240411] MODIFY FILE (NAME='AdventureWorks2017_log' , FILENAME='G:\SQL2022\SSDE_LOG\AdventureWorks_log_2404110239.ldf');
				ALTER DATABASE [Demo20240411] SET ONLINE;
...
BEGIN TRY
	...
	BEGIN
		...
		BEGIN
			...
			END
			INSERT INTO #results
			EXEC master..xp_cmdshell 'copy "C:\Program Files\Microsoft SQL Server\MSSQL16.SQL2022\MSSQL\DATA\AdventureWorks_Log_2404030619.ldf" "G:\SQL2022\SSDE_LOG\AdventureWorks_Log_2404030619.ldf" /Z /Y ';
			IF EXISTS(SELECT * FROM #results WHERE result LIKE '%1 file(s) copied.%')
			BEGIN
				ALTER DATABASE [DemoAdvApril03] MODIFY FILE (NAME='AdventureWorks2016_Log' , FILENAME='G:\SQL2022\SSDE_LOG\AdventureWorks_Log_2404030619.ldf');
				ALTER DATABASE [DemoAdvApril03] SET ONLINE;
...
BEGIN TRY
	...
	BEGIN
		...
		BEGIN
			...
			END
			INSERT INTO #results
			EXEC master..xp_cmdshell 'copy "C:\Program Files\Microsoft SQL Server\MSSQL16.SQL2022\MSSQL\DATA\AdventureWorks_log_2404240750.ldf" "G:\SQL2022\SSDE_LOG\AdventureWorks_log_2404240750.ldf" /Z /Y ';
			IF EXISTS(SELECT * FROM #results WHERE result LIKE '%1 file(s) copied.%')
			BEGIN
				ALTER DATABASE [newdbemo3099] MODIFY FILE (NAME='AdventureWorks2022_log' , FILENAME='G:\SQL2022\SSDE_LOG\AdventureWorks_log_2404240750.ldf');
				ALTER DATABASE [newdbemo3099] SET ONLINE;
...
BEGIN TRY
	...
	BEGIN
		...
		BEGIN
			...
			END
			INSERT INTO #results
			EXEC master..xp_cmdshell 'copy "C:\Program Files\Microsoft SQL Server\MSSQL16.SQL2022\MSSQL\DATA\AdventureWorks_Log_2404230439.ldf" "G:\SQL2022\SSDE_LOG\AdventureWorks_Log_2404230439.ldf" /Z /Y ';
			IF EXISTS(SELECT * FROM #results WHERE result LIKE '%1 file(s) copied.%')
			BEGIN
				ALTER DATABASE [test] MODIFY FILE (NAME='AdventureWorks2016_Log' , FILENAME='G:\SQL2022\SSDE_LOG\AdventureWorks_Log_2404230439.ldf');
				ALTER DATABASE [test] SET ONLINE;
