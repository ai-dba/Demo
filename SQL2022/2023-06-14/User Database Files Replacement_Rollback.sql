...
BEGIN TRY
	...
	BEGIN
		...
		IF (SELECT physical_name FROM sys.master_files WHERE database_id = DB_ID(N'AdventureWorks') AND FILE_ID = 1) = 'D:\SQL2022\SSDE_DATA\AdventureWorks.mdf'
		BEGIN
			...
			END
			INSERT INTO #results
			EXEC master..xp_cmdshell 'copy "D:\SQL2022\SSDE_DATA\AdventureWorks.mdf" "C:\Program Files\Microsoft SQL Server\MSSQL16.SQL2022\MSSQL\DATA\AdventureWorks.mdf" /Z /Y';
			...
			BEGIN
				...
				EXEC master..xp_cmdshell 'del "D:\SQL2022\SSDE_DATA\AdventureWorks.mdf" "C:\Program Files\Microsoft SQL Server\MSSQL16.SQL2022\MSSQL\DATA\AdventureWorks.mdf"';
			END
			ELSE
			BEGIN
				ALTER DATABASE [AdventureWorks] SET ONLINE;
