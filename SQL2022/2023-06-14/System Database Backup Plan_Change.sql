		...
		SET @Azure_Credential_Name_master = 'Insert Azure Credential Name'
				...
				IF('AIDBA_System_Databases_Backups(SQL2022)\Master' NOT IN (SELECT * FROM @ResultSer_Master))
				BEGIN
					EXEC master..xp_cmdshell 'MKDIR C:\AIDBA_System_Databases_Backups(SQL2022)\Master',NO_OUTPUT;
				END
		...
		SET @Azure_Credential_Name_msdb = 'Insert Azure Credential Name'
				...
				IF('AIDBA_System_Databases_Backups(SQL2022)\Msdb' NOT IN (SELECT * FROM @ResultSer_MSDB))
				BEGIN
					EXEC master..xp_cmdshell 'MKDIR C:\AIDBA_System_Databases_Backups(SQL2022)\Msdb',NO_OUTPUT;
				END
		...
		SET @Azure_Credential_Name_model = 'Insert Azure Credential Name'
				...
				IF('AIDBA_System_Databases_Backups(SQL2022)\Model' NOT IN (SELECT * FROM @ResultSer_Model))
				BEGIN
					EXEC master..xp_cmdshell 'MKDIR C:\AIDBA_System_Databases_Backups(SQL2022)\Model',NO_OUTPUT;
				END
