...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [advnew2019].sys.stats S CROSS APPLY [advnew2019].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000003_4CA06362' AND OBJECT_NAME(S.OBJECT_ID) = 'BusinessEntity' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [advnew2019].[Person].[BusinessEntity] [_WA_Sys_00000003_4CA06362] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000003_4CA06362] on [advnew2019].[Person].[BusinessEntity] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000003_4CA06362] on [advnew2019].[Person].[BusinessEntity] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [advnew2019].sys.stats S CROSS APPLY [advnew2019].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'AK_BusinessEntity_rowguid' AND OBJECT_NAME(S.OBJECT_ID) = 'BusinessEntity' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [advnew2019].[Person].[BusinessEntity] [AK_BusinessEntity_rowguid] WITH FULLSCAN ;
		END
		PRINT '[AK_BusinessEntity_rowguid] on [advnew2019].[Person].[BusinessEntity] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[AK_BusinessEntity_rowguid] on [advnew2019].[Person].[BusinessEntity] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [advnew2019].sys.stats S CROSS APPLY [advnew2019].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'PK_BusinessEntity_BusinessEntityID' AND OBJECT_NAME(S.OBJECT_ID) = 'BusinessEntity' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [advnew2019].[Person].[BusinessEntity] [PK_BusinessEntity_BusinessEntityID] WITH FULLSCAN ;
		END
		PRINT '[PK_BusinessEntity_BusinessEntityID] on [advnew2019].[Person].[BusinessEntity] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[PK_BusinessEntity_BusinessEntityID] on [advnew2019].[Person].[BusinessEntity] cannot be updated.';			
	END CATCH;
END
