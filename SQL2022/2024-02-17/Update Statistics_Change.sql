...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdvNewDB2022Portal].sys.stats S CROSS APPLY [AdvNewDB2022Portal].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'IX_PurchaseOrderDetail_ProductID' AND OBJECT_NAME(S.OBJECT_ID) = 'PurchaseOrderDetail' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdvNewDB2022Portal].[Purchasing].[PurchaseOrderDetail] [IX_PurchaseOrderDetail_ProductID] WITH FULLSCAN ;
		END
		PRINT '[IX_PurchaseOrderDetail_ProductID] on [AdvNewDB2022Portal].[Purchasing].[PurchaseOrderDetail] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[IX_PurchaseOrderDetail_ProductID] on [AdvNewDB2022Portal].[Purchasing].[PurchaseOrderDetail] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdvNewDB2022Portal].sys.stats S CROSS APPLY [AdvNewDB2022Portal].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID' AND OBJECT_NAME(S.OBJECT_ID) = 'PurchaseOrderDetail' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdvNewDB2022Portal].[Purchasing].[PurchaseOrderDetail] [PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID] WITH FULLSCAN ;
		END
		PRINT '[PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID] on [AdvNewDB2022Portal].[Purchasing].[PurchaseOrderDetail] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID] on [AdvNewDB2022Portal].[Purchasing].[PurchaseOrderDetail] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks_20240130190806].sys.stats S CROSS APPLY [AdventureWorks_20240130190806].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'IX_PurchaseOrderDetail_ProductID' AND OBJECT_NAME(S.OBJECT_ID) = 'PurchaseOrderDetail' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks_20240130190806].[Purchasing].[PurchaseOrderDetail] [IX_PurchaseOrderDetail_ProductID] WITH FULLSCAN ;
		END
		PRINT '[IX_PurchaseOrderDetail_ProductID] on [AdventureWorks_20240130190806].[Purchasing].[PurchaseOrderDetail] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[IX_PurchaseOrderDetail_ProductID] on [AdventureWorks_20240130190806].[Purchasing].[PurchaseOrderDetail] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks_20240130190806].sys.stats S CROSS APPLY [AdventureWorks_20240130190806].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID' AND OBJECT_NAME(S.OBJECT_ID) = 'PurchaseOrderDetail' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks_20240130190806].[Purchasing].[PurchaseOrderDetail] [PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID] WITH FULLSCAN ;
		END
		PRINT '[PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID] on [AdventureWorks_20240130190806].[Purchasing].[PurchaseOrderDetail] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID] on [AdventureWorks_20240130190806].[Purchasing].[PurchaseOrderDetail] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [Advnew2022].sys.stats S CROSS APPLY [Advnew2022].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'IX_PurchaseOrderDetail_ProductID' AND OBJECT_NAME(S.OBJECT_ID) = 'PurchaseOrderDetail' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [Advnew2022].[Purchasing].[PurchaseOrderDetail] [IX_PurchaseOrderDetail_ProductID] WITH FULLSCAN ;
		END
		PRINT '[IX_PurchaseOrderDetail_ProductID] on [Advnew2022].[Purchasing].[PurchaseOrderDetail] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[IX_PurchaseOrderDetail_ProductID] on [Advnew2022].[Purchasing].[PurchaseOrderDetail] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [Advnew2022].sys.stats S CROSS APPLY [Advnew2022].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID' AND OBJECT_NAME(S.OBJECT_ID) = 'PurchaseOrderDetail' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [Advnew2022].[Purchasing].[PurchaseOrderDetail] [PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID] WITH FULLSCAN ;
		END
		PRINT '[PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID] on [Advnew2022].[Purchasing].[PurchaseOrderDetail] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID] on [Advnew2022].[Purchasing].[PurchaseOrderDetail] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks_20240103030343].sys.stats S CROSS APPLY [AdventureWorks_20240103030343].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'IX_PurchaseOrderDetail_ProductID' AND OBJECT_NAME(S.OBJECT_ID) = 'PurchaseOrderDetail' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks_20240103030343].[Purchasing].[PurchaseOrderDetail] [IX_PurchaseOrderDetail_ProductID] WITH FULLSCAN ;
		END
		PRINT '[IX_PurchaseOrderDetail_ProductID] on [AdventureWorks_20240103030343].[Purchasing].[PurchaseOrderDetail] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[IX_PurchaseOrderDetail_ProductID] on [AdventureWorks_20240103030343].[Purchasing].[PurchaseOrderDetail] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		...
		BEGIN
			UPDATE STATISTICS [AdventureWorks_20240103030343].[Purchasing].[PurchaseOrderDetail] [PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID] WITH FULLSCAN ;
		END
		PRINT '[PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID] on [AdventureWorks_20240103030343].[Purchasing].[PurchaseOrderDetail] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID] on [AdventureWorks_20240103030343].[Purchasing].[PurchaseOrderDetail] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks_20240103030343].sys.stats S CROSS APPLY [AdventureWorks_20240103030343].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000006_4C6B5938' AND OBJECT_NAME(S.OBJECT_ID) = 'PurchaseOrderHeader' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks_20240103030343].[Purchasing].[PurchaseOrderHeader] [_WA_Sys_00000006_4C6B5938] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000006_4C6B5938] on [AdventureWorks_20240103030343].[Purchasing].[PurchaseOrderHeader] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000006_4C6B5938] on [AdventureWorks_20240103030343].[Purchasing].[PurchaseOrderHeader] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks_20240103030343].sys.stats S CROSS APPLY [AdventureWorks_20240103030343].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'IX_PurchaseOrderHeader_EmployeeID' AND OBJECT_NAME(S.OBJECT_ID) = 'PurchaseOrderHeader' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks_20240103030343].[Purchasing].[PurchaseOrderHeader] [IX_PurchaseOrderHeader_EmployeeID] WITH FULLSCAN ;
		END
		PRINT '[IX_PurchaseOrderHeader_EmployeeID] on [AdventureWorks_20240103030343].[Purchasing].[PurchaseOrderHeader] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[IX_PurchaseOrderHeader_EmployeeID] on [AdventureWorks_20240103030343].[Purchasing].[PurchaseOrderHeader] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks_20240103030343].sys.stats S CROSS APPLY [AdventureWorks_20240103030343].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'IX_PurchaseOrderHeader_VendorID' AND OBJECT_NAME(S.OBJECT_ID) = 'PurchaseOrderHeader' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks_20240103030343].[Purchasing].[PurchaseOrderHeader] [IX_PurchaseOrderHeader_VendorID] WITH FULLSCAN ;
		END
		PRINT '[IX_PurchaseOrderHeader_VendorID] on [AdventureWorks_20240103030343].[Purchasing].[PurchaseOrderHeader] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[IX_PurchaseOrderHeader_VendorID] on [AdventureWorks_20240103030343].[Purchasing].[PurchaseOrderHeader] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks_20240103030343].sys.stats S CROSS APPLY [AdventureWorks_20240103030343].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'PK_PurchaseOrderHeader_PurchaseOrderID' AND OBJECT_NAME(S.OBJECT_ID) = 'PurchaseOrderHeader' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks_20240103030343].[Purchasing].[PurchaseOrderHeader] [PK_PurchaseOrderHeader_PurchaseOrderID] WITH FULLSCAN ;
		END
		PRINT '[PK_PurchaseOrderHeader_PurchaseOrderID] on [AdventureWorks_20240103030343].[Purchasing].[PurchaseOrderHeader] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[PK_PurchaseOrderHeader_PurchaseOrderID] on [AdventureWorks_20240103030343].[Purchasing].[PurchaseOrderHeader] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [Advnew2022].sys.stats S CROSS APPLY [Advnew2022].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000006_4B7734FF' AND OBJECT_NAME(S.OBJECT_ID) = 'PurchaseOrderHeader' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [Advnew2022].[Purchasing].[PurchaseOrderHeader] [_WA_Sys_00000006_4B7734FF] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000006_4B7734FF] on [Advnew2022].[Purchasing].[PurchaseOrderHeader] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000006_4B7734FF] on [Advnew2022].[Purchasing].[PurchaseOrderHeader] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [Advnew2022].sys.stats S CROSS APPLY [Advnew2022].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'IX_PurchaseOrderHeader_EmployeeID' AND OBJECT_NAME(S.OBJECT_ID) = 'PurchaseOrderHeader' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [Advnew2022].[Purchasing].[PurchaseOrderHeader] [IX_PurchaseOrderHeader_EmployeeID] WITH FULLSCAN ;
		END
		PRINT '[IX_PurchaseOrderHeader_EmployeeID] on [Advnew2022].[Purchasing].[PurchaseOrderHeader] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[IX_PurchaseOrderHeader_EmployeeID] on [Advnew2022].[Purchasing].[PurchaseOrderHeader] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [Advnew2022].sys.stats S CROSS APPLY [Advnew2022].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'IX_PurchaseOrderHeader_VendorID' AND OBJECT_NAME(S.OBJECT_ID) = 'PurchaseOrderHeader' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [Advnew2022].[Purchasing].[PurchaseOrderHeader] [IX_PurchaseOrderHeader_VendorID] WITH FULLSCAN ;
		END
		PRINT '[IX_PurchaseOrderHeader_VendorID] on [Advnew2022].[Purchasing].[PurchaseOrderHeader] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[IX_PurchaseOrderHeader_VendorID] on [Advnew2022].[Purchasing].[PurchaseOrderHeader] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [Advnew2022].sys.stats S CROSS APPLY [Advnew2022].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'PK_PurchaseOrderHeader_PurchaseOrderID' AND OBJECT_NAME(S.OBJECT_ID) = 'PurchaseOrderHeader' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [Advnew2022].[Purchasing].[PurchaseOrderHeader] [PK_PurchaseOrderHeader_PurchaseOrderID] WITH FULLSCAN ;
		END
		PRINT '[PK_PurchaseOrderHeader_PurchaseOrderID] on [Advnew2022].[Purchasing].[PurchaseOrderHeader] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[PK_PurchaseOrderHeader_PurchaseOrderID] on [Advnew2022].[Purchasing].[PurchaseOrderHeader] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks_20240130190806].sys.stats S CROSS APPLY [AdventureWorks_20240130190806].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000006_4C6B5938' AND OBJECT_NAME(S.OBJECT_ID) = 'PurchaseOrderHeader' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks_20240130190806].[Purchasing].[PurchaseOrderHeader] [_WA_Sys_00000006_4C6B5938] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000006_4C6B5938] on [AdventureWorks_20240130190806].[Purchasing].[PurchaseOrderHeader] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000006_4C6B5938] on [AdventureWorks_20240130190806].[Purchasing].[PurchaseOrderHeader] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks_20240130190806].sys.stats S CROSS APPLY [AdventureWorks_20240130190806].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'IX_PurchaseOrderHeader_EmployeeID' AND OBJECT_NAME(S.OBJECT_ID) = 'PurchaseOrderHeader' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks_20240130190806].[Purchasing].[PurchaseOrderHeader] [IX_PurchaseOrderHeader_EmployeeID] WITH FULLSCAN ;
		END
		PRINT '[IX_PurchaseOrderHeader_EmployeeID] on [AdventureWorks_20240130190806].[Purchasing].[PurchaseOrderHeader] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[IX_PurchaseOrderHeader_EmployeeID] on [AdventureWorks_20240130190806].[Purchasing].[PurchaseOrderHeader] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks_20240130190806].sys.stats S CROSS APPLY [AdventureWorks_20240130190806].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'IX_PurchaseOrderHeader_VendorID' AND OBJECT_NAME(S.OBJECT_ID) = 'PurchaseOrderHeader' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks_20240130190806].[Purchasing].[PurchaseOrderHeader] [IX_PurchaseOrderHeader_VendorID] WITH FULLSCAN ;
		END
		PRINT '[IX_PurchaseOrderHeader_VendorID] on [AdventureWorks_20240130190806].[Purchasing].[PurchaseOrderHeader] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[IX_PurchaseOrderHeader_VendorID] on [AdventureWorks_20240130190806].[Purchasing].[PurchaseOrderHeader] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks_20240130190806].sys.stats S CROSS APPLY [AdventureWorks_20240130190806].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'PK_PurchaseOrderHeader_PurchaseOrderID' AND OBJECT_NAME(S.OBJECT_ID) = 'PurchaseOrderHeader' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks_20240130190806].[Purchasing].[PurchaseOrderHeader] [PK_PurchaseOrderHeader_PurchaseOrderID] WITH FULLSCAN ;
		END
		PRINT '[PK_PurchaseOrderHeader_PurchaseOrderID] on [AdventureWorks_20240130190806].[Purchasing].[PurchaseOrderHeader] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[PK_PurchaseOrderHeader_PurchaseOrderID] on [AdventureWorks_20240130190806].[Purchasing].[PurchaseOrderHeader] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdvNewDB2022Portal].sys.stats S CROSS APPLY [AdvNewDB2022Portal].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000006_4C6B5938' AND OBJECT_NAME(S.OBJECT_ID) = 'PurchaseOrderHeader' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdvNewDB2022Portal].[Purchasing].[PurchaseOrderHeader] [_WA_Sys_00000006_4C6B5938] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000006_4C6B5938] on [AdvNewDB2022Portal].[Purchasing].[PurchaseOrderHeader] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000006_4C6B5938] on [AdvNewDB2022Portal].[Purchasing].[PurchaseOrderHeader] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdvNewDB2022Portal].sys.stats S CROSS APPLY [AdvNewDB2022Portal].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'IX_PurchaseOrderHeader_EmployeeID' AND OBJECT_NAME(S.OBJECT_ID) = 'PurchaseOrderHeader' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdvNewDB2022Portal].[Purchasing].[PurchaseOrderHeader] [IX_PurchaseOrderHeader_EmployeeID] WITH FULLSCAN ;
		END
		PRINT '[IX_PurchaseOrderHeader_EmployeeID] on [AdvNewDB2022Portal].[Purchasing].[PurchaseOrderHeader] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[IX_PurchaseOrderHeader_EmployeeID] on [AdvNewDB2022Portal].[Purchasing].[PurchaseOrderHeader] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdvNewDB2022Portal].sys.stats S CROSS APPLY [AdvNewDB2022Portal].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'IX_PurchaseOrderHeader_VendorID' AND OBJECT_NAME(S.OBJECT_ID) = 'PurchaseOrderHeader' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdvNewDB2022Portal].[Purchasing].[PurchaseOrderHeader] [IX_PurchaseOrderHeader_VendorID] WITH FULLSCAN ;
		END
		PRINT '[IX_PurchaseOrderHeader_VendorID] on [AdvNewDB2022Portal].[Purchasing].[PurchaseOrderHeader] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[IX_PurchaseOrderHeader_VendorID] on [AdvNewDB2022Portal].[Purchasing].[PurchaseOrderHeader] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdvNewDB2022Portal].sys.stats S CROSS APPLY [AdvNewDB2022Portal].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'PK_PurchaseOrderHeader_PurchaseOrderID' AND OBJECT_NAME(S.OBJECT_ID) = 'PurchaseOrderHeader' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdvNewDB2022Portal].[Purchasing].[PurchaseOrderHeader] [PK_PurchaseOrderHeader_PurchaseOrderID] WITH FULLSCAN ;
		END
		PRINT '[PK_PurchaseOrderHeader_PurchaseOrderID] on [AdvNewDB2022Portal].[Purchasing].[PurchaseOrderHeader] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[PK_PurchaseOrderHeader_PurchaseOrderID] on [AdvNewDB2022Portal].[Purchasing].[PurchaseOrderHeader] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdvNewDB2022Portal].sys.stats S CROSS APPLY [AdvNewDB2022Portal].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000003_31EC6D26' AND OBJECT_NAME(S.OBJECT_ID) = 'BillOfMaterials' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdvNewDB2022Portal].[Production].[BillOfMaterials] [_WA_Sys_00000003_31EC6D26] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000003_31EC6D26] on [AdvNewDB2022Portal].[Production].[BillOfMaterials] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000003_31EC6D26] on [AdvNewDB2022Portal].[Production].[BillOfMaterials] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdvNewDB2022Portal].sys.stats S CROSS APPLY [AdvNewDB2022Portal].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate' AND OBJECT_NAME(S.OBJECT_ID) = 'BillOfMaterials' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdvNewDB2022Portal].[Production].[BillOfMaterials] [AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate] WITH FULLSCAN ;
		END
		PRINT '[AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate] on [AdvNewDB2022Portal].[Production].[BillOfMaterials] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate] on [AdvNewDB2022Portal].[Production].[BillOfMaterials] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdvNewDB2022Portal].sys.stats S CROSS APPLY [AdvNewDB2022Portal].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'IX_BillOfMaterials_UnitMeasureCode' AND OBJECT_NAME(S.OBJECT_ID) = 'BillOfMaterials' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdvNewDB2022Portal].[Production].[BillOfMaterials] [IX_BillOfMaterials_UnitMeasureCode] WITH FULLSCAN ;
		END
		PRINT '[IX_BillOfMaterials_UnitMeasureCode] on [AdvNewDB2022Portal].[Production].[BillOfMaterials] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[IX_BillOfMaterials_UnitMeasureCode] on [AdvNewDB2022Portal].[Production].[BillOfMaterials] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdvNewDB2022Portal].sys.stats S CROSS APPLY [AdvNewDB2022Portal].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'PK_BillOfMaterials_BillOfMaterialsID' AND OBJECT_NAME(S.OBJECT_ID) = 'BillOfMaterials' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdvNewDB2022Portal].[Production].[BillOfMaterials] [PK_BillOfMaterials_BillOfMaterialsID] WITH FULLSCAN ;
		END
		PRINT '[PK_BillOfMaterials_BillOfMaterialsID] on [AdvNewDB2022Portal].[Production].[BillOfMaterials] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[PK_BillOfMaterials_BillOfMaterialsID] on [AdvNewDB2022Portal].[Production].[BillOfMaterials] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks_20240130190806].sys.stats S CROSS APPLY [AdventureWorks_20240130190806].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000003_31EC6D26' AND OBJECT_NAME(S.OBJECT_ID) = 'BillOfMaterials' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks_20240130190806].[Production].[BillOfMaterials] [_WA_Sys_00000003_31EC6D26] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000003_31EC6D26] on [AdventureWorks_20240130190806].[Production].[BillOfMaterials] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000003_31EC6D26] on [AdventureWorks_20240130190806].[Production].[BillOfMaterials] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks_20240130190806].sys.stats S CROSS APPLY [AdventureWorks_20240130190806].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate' AND OBJECT_NAME(S.OBJECT_ID) = 'BillOfMaterials' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks_20240130190806].[Production].[BillOfMaterials] [AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate] WITH FULLSCAN ;
		END
		PRINT '[AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate] on [AdventureWorks_20240130190806].[Production].[BillOfMaterials] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate] on [AdventureWorks_20240130190806].[Production].[BillOfMaterials] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks_20240130190806].sys.stats S CROSS APPLY [AdventureWorks_20240130190806].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'IX_BillOfMaterials_UnitMeasureCode' AND OBJECT_NAME(S.OBJECT_ID) = 'BillOfMaterials' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks_20240130190806].[Production].[BillOfMaterials] [IX_BillOfMaterials_UnitMeasureCode] WITH FULLSCAN ;
		END
		PRINT '[IX_BillOfMaterials_UnitMeasureCode] on [AdventureWorks_20240130190806].[Production].[BillOfMaterials] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[IX_BillOfMaterials_UnitMeasureCode] on [AdventureWorks_20240130190806].[Production].[BillOfMaterials] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks_20240130190806].sys.stats S CROSS APPLY [AdventureWorks_20240130190806].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'PK_BillOfMaterials_BillOfMaterialsID' AND OBJECT_NAME(S.OBJECT_ID) = 'BillOfMaterials' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks_20240130190806].[Production].[BillOfMaterials] [PK_BillOfMaterials_BillOfMaterialsID] WITH FULLSCAN ;
		END
		PRINT '[PK_BillOfMaterials_BillOfMaterialsID] on [AdventureWorks_20240130190806].[Production].[BillOfMaterials] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[PK_BillOfMaterials_BillOfMaterialsID] on [AdventureWorks_20240130190806].[Production].[BillOfMaterials] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks_20240103030343].sys.stats S CROSS APPLY [AdventureWorks_20240103030343].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000003_31EC6D26' AND OBJECT_NAME(S.OBJECT_ID) = 'BillOfMaterials' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks_20240103030343].[Production].[BillOfMaterials] [_WA_Sys_00000003_31EC6D26] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000003_31EC6D26] on [AdventureWorks_20240103030343].[Production].[BillOfMaterials] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000003_31EC6D26] on [AdventureWorks_20240103030343].[Production].[BillOfMaterials] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks_20240103030343].sys.stats S CROSS APPLY [AdventureWorks_20240103030343].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate' AND OBJECT_NAME(S.OBJECT_ID) = 'BillOfMaterials' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks_20240103030343].[Production].[BillOfMaterials] [AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate] WITH FULLSCAN ;
		END
		PRINT '[AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate] on [AdventureWorks_20240103030343].[Production].[BillOfMaterials] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate] on [AdventureWorks_20240103030343].[Production].[BillOfMaterials] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks_20240103030343].sys.stats S CROSS APPLY [AdventureWorks_20240103030343].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'IX_BillOfMaterials_UnitMeasureCode' AND OBJECT_NAME(S.OBJECT_ID) = 'BillOfMaterials' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks_20240103030343].[Production].[BillOfMaterials] [IX_BillOfMaterials_UnitMeasureCode] WITH FULLSCAN ;
		END
		PRINT '[IX_BillOfMaterials_UnitMeasureCode] on [AdventureWorks_20240103030343].[Production].[BillOfMaterials] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[IX_BillOfMaterials_UnitMeasureCode] on [AdventureWorks_20240103030343].[Production].[BillOfMaterials] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks_20240103030343].sys.stats S CROSS APPLY [AdventureWorks_20240103030343].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'PK_BillOfMaterials_BillOfMaterialsID' AND OBJECT_NAME(S.OBJECT_ID) = 'BillOfMaterials' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks_20240103030343].[Production].[BillOfMaterials] [PK_BillOfMaterials_BillOfMaterialsID] WITH FULLSCAN ;
		END
		PRINT '[PK_BillOfMaterials_BillOfMaterialsID] on [AdventureWorks_20240103030343].[Production].[BillOfMaterials] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[PK_BillOfMaterials_BillOfMaterialsID] on [AdventureWorks_20240103030343].[Production].[BillOfMaterials] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [Advnew2022].sys.stats S CROSS APPLY [Advnew2022].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000003_30F848ED' AND OBJECT_NAME(S.OBJECT_ID) = 'BillOfMaterials' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [Advnew2022].[Production].[BillOfMaterials] [_WA_Sys_00000003_30F848ED] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000003_30F848ED] on [Advnew2022].[Production].[BillOfMaterials] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000003_30F848ED] on [Advnew2022].[Production].[BillOfMaterials] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [Advnew2022].sys.stats S CROSS APPLY [Advnew2022].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate' AND OBJECT_NAME(S.OBJECT_ID) = 'BillOfMaterials' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [Advnew2022].[Production].[BillOfMaterials] [AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate] WITH FULLSCAN ;
		END
		PRINT '[AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate] on [Advnew2022].[Production].[BillOfMaterials] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate] on [Advnew2022].[Production].[BillOfMaterials] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [Advnew2022].sys.stats S CROSS APPLY [Advnew2022].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'IX_BillOfMaterials_UnitMeasureCode' AND OBJECT_NAME(S.OBJECT_ID) = 'BillOfMaterials' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [Advnew2022].[Production].[BillOfMaterials] [IX_BillOfMaterials_UnitMeasureCode] WITH FULLSCAN ;
		END
		PRINT '[IX_BillOfMaterials_UnitMeasureCode] on [Advnew2022].[Production].[BillOfMaterials] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[IX_BillOfMaterials_UnitMeasureCode] on [Advnew2022].[Production].[BillOfMaterials] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [Advnew2022].sys.stats S CROSS APPLY [Advnew2022].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'PK_BillOfMaterials_BillOfMaterialsID' AND OBJECT_NAME(S.OBJECT_ID) = 'BillOfMaterials' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [Advnew2022].[Production].[BillOfMaterials] [PK_BillOfMaterials_BillOfMaterialsID] WITH FULLSCAN ;
		END
		PRINT '[PK_BillOfMaterials_BillOfMaterialsID] on [Advnew2022].[Production].[BillOfMaterials] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[PK_BillOfMaterials_BillOfMaterialsID] on [Advnew2022].[Production].[BillOfMaterials] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [Advnew2022].sys.stats S CROSS APPLY [Advnew2022].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000002_22751F6C' AND OBJECT_NAME(S.OBJECT_ID) = 'ProductInventory' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [Advnew2022].[Production].[ProductInventory] [_WA_Sys_00000002_22751F6C] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000002_22751F6C] on [Advnew2022].[Production].[ProductInventory] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000002_22751F6C] on [Advnew2022].[Production].[ProductInventory] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [Advnew2022].sys.stats S CROSS APPLY [Advnew2022].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'PK_ProductInventory_ProductID_LocationID' AND OBJECT_NAME(S.OBJECT_ID) = 'ProductInventory' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [Advnew2022].[Production].[ProductInventory] [PK_ProductInventory_ProductID_LocationID] WITH FULLSCAN ;
		END
		PRINT '[PK_ProductInventory_ProductID_LocationID] on [Advnew2022].[Production].[ProductInventory] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[PK_ProductInventory_ProductID_LocationID] on [Advnew2022].[Production].[ProductInventory] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks_20240103030343].sys.stats S CROSS APPLY [AdventureWorks_20240103030343].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000002_236943A5' AND OBJECT_NAME(S.OBJECT_ID) = 'ProductInventory' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks_20240103030343].[Production].[ProductInventory] [_WA_Sys_00000002_236943A5] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000002_236943A5] on [AdventureWorks_20240103030343].[Production].[ProductInventory] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000002_236943A5] on [AdventureWorks_20240103030343].[Production].[ProductInventory] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks_20240103030343].sys.stats S CROSS APPLY [AdventureWorks_20240103030343].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'PK_ProductInventory_ProductID_LocationID' AND OBJECT_NAME(S.OBJECT_ID) = 'ProductInventory' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks_20240103030343].[Production].[ProductInventory] [PK_ProductInventory_ProductID_LocationID] WITH FULLSCAN ;
		END
		PRINT '[PK_ProductInventory_ProductID_LocationID] on [AdventureWorks_20240103030343].[Production].[ProductInventory] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[PK_ProductInventory_ProductID_LocationID] on [AdventureWorks_20240103030343].[Production].[ProductInventory] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks_20240130190806].sys.stats S CROSS APPLY [AdventureWorks_20240130190806].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000002_236943A5' AND OBJECT_NAME(S.OBJECT_ID) = 'ProductInventory' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks_20240130190806].[Production].[ProductInventory] [_WA_Sys_00000002_236943A5] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000002_236943A5] on [AdventureWorks_20240130190806].[Production].[ProductInventory] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000002_236943A5] on [AdventureWorks_20240130190806].[Production].[ProductInventory] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdventureWorks_20240130190806].sys.stats S CROSS APPLY [AdventureWorks_20240130190806].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'PK_ProductInventory_ProductID_LocationID' AND OBJECT_NAME(S.OBJECT_ID) = 'ProductInventory' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdventureWorks_20240130190806].[Production].[ProductInventory] [PK_ProductInventory_ProductID_LocationID] WITH FULLSCAN ;
		END
		PRINT '[PK_ProductInventory_ProductID_LocationID] on [AdventureWorks_20240130190806].[Production].[ProductInventory] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[PK_ProductInventory_ProductID_LocationID] on [AdventureWorks_20240130190806].[Production].[ProductInventory] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdvNewDB2022Portal].sys.stats S CROSS APPLY [AdvNewDB2022Portal].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000002_236943A5' AND OBJECT_NAME(S.OBJECT_ID) = 'ProductInventory' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdvNewDB2022Portal].[Production].[ProductInventory] [_WA_Sys_00000002_236943A5] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000002_236943A5] on [AdvNewDB2022Portal].[Production].[ProductInventory] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000002_236943A5] on [AdvNewDB2022Portal].[Production].[ProductInventory] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [AdvNewDB2022Portal].sys.stats S CROSS APPLY [AdvNewDB2022Portal].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'PK_ProductInventory_ProductID_LocationID' AND OBJECT_NAME(S.OBJECT_ID) = 'ProductInventory' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [AdvNewDB2022Portal].[Production].[ProductInventory] [PK_ProductInventory_ProductID_LocationID] WITH FULLSCAN ;
		END
		PRINT '[PK_ProductInventory_ProductID_LocationID] on [AdvNewDB2022Portal].[Production].[ProductInventory] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[PK_ProductInventory_ProductID_LocationID] on [AdvNewDB2022Portal].[Production].[ProductInventory] cannot be updated.';			
	END CATCH;
END
