		...
		ALTER INDEX [AK_Address_rowguid] ON [AdventureWorks_20240103030343].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_Address_rowguid] ON [AdventureWorks_20240130190806].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_Address_rowguid] ON [Advnew2022].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate] ON [AdventureWorks_20240103030343].[Production].[BillOfMaterials] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate] ON [AdventureWorks_20240130190806].[Production].[BillOfMaterials] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate] ON [Advnew2022].[Production].[BillOfMaterials] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate] ON [AdvNew2022Restored].[Production].[BillOfMaterials] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate] ON [AdvNew2022Restored2].[Production].[BillOfMaterials] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate] ON [AdvNew2022Restored3].[Production].[BillOfMaterials] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_BillOfMaterials_ProductAssemblyID_ComponentID_StartDate] ON [AdvNewDB2022Portal].[Production].[BillOfMaterials] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_BusinessEntity_rowguid] ON [AdventureWorks].[Person].[BusinessEntity] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_BusinessEntity_rowguid] ON [AdventureWorks_20240103030343].[Person].[BusinessEntity] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_BusinessEntity_rowguid] ON [AdventureWorks_20240130190806].[Person].[BusinessEntity] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_BusinessEntity_rowguid] ON [Advnew2022].[Person].[BusinessEntity] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [AK_BusinessEntityAddress_rowguid] ON [AdventureWorks_20240103030343].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_BusinessEntityAddress_rowguid] ON [AdventureWorks_20240130190806].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_BusinessEntityAddress_rowguid] ON [Advnew2022].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [AK_CreditCard_CardNumber] ON [AdventureWorks_20240103030343].[Sales].[CreditCard] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_CreditCard_CardNumber] ON [AdventureWorks_20240130190806].[Sales].[CreditCard] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_CreditCard_CardNumber] ON [Advnew2022].[Sales].[CreditCard] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [AK_CurrencyRate_CurrencyRateDate_FromCurrencyCode_ToCurrencyCode] ON [AdventureWorks_20240103030343].[Sales].[CurrencyRate] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_CurrencyRate_CurrencyRateDate_FromCurrencyCode_ToCurrencyCode] ON [AdventureWorks_20240130190806].[Sales].[CurrencyRate] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_CurrencyRate_CurrencyRateDate_FromCurrencyCode_ToCurrencyCode] ON [Advnew2022].[Sales].[CurrencyRate] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [AK_Customer_AccountNumber] ON [AdventureWorks_20240103030343].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_Customer_AccountNumber] ON [AdventureWorks_20240130190806].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_Customer_AccountNumber] ON [Advnew2022].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [AK_Customer_rowguid] ON [AdventureWorks_20240103030343].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_Customer_rowguid] ON [AdventureWorks_20240130190806].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_Customer_rowguid] ON [Advnew2022].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [AK_Person_rowguid] ON [AdventureWorks_20240103030343].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_Person_rowguid] ON [AdventureWorks_20240130190806].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_Person_rowguid] ON [Advnew2022].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [AK_SalesOrderDetail_rowguid] ON [AdventureWorks_20240103030343].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_SalesOrderDetail_rowguid] ON [AdventureWorks_20240130190806].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_SalesOrderDetail_rowguid] ON [Advnew2022].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [AK_SalesOrderHeader_rowguid] ON [AdventureWorks_20240103030343].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_SalesOrderHeader_rowguid] ON [AdventureWorks_20240130190806].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_SalesOrderHeader_rowguid] ON [Advnew2022].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [AK_SalesOrderHeader_SalesOrderNumber] ON [AdventureWorks_20240103030343].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_SalesOrderHeader_SalesOrderNumber] ON [AdventureWorks_20240130190806].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [AK_SalesOrderHeader_SalesOrderNumber] ON [Advnew2022].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [IX_Address_AddressLine1_AddressLine2_City_StateProvinceID_PostalCode] ON [AdventureWorks_20240103030343].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_Address_AddressLine1_AddressLine2_City_StateProvinceID_PostalCode] ON [AdventureWorks_20240130190806].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_Address_AddressLine1_AddressLine2_City_StateProvinceID_PostalCode] ON [Advnew2022].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [IX_Address_StateProvinceID] ON [AdventureWorks_20240103030343].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_Address_StateProvinceID] ON [AdventureWorks_20240130190806].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_Address_StateProvinceID] ON [Advnew2022].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [IX_BillOfMaterials_UnitMeasureCode] ON [AdventureWorks_20240103030343].[Production].[BillOfMaterials] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_BillOfMaterials_UnitMeasureCode] ON [AdventureWorks_20240130190806].[Production].[BillOfMaterials] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_BillOfMaterials_UnitMeasureCode] ON [Advnew2022].[Production].[BillOfMaterials] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_BillOfMaterials_UnitMeasureCode] ON [AdvNew2022Restored].[Production].[BillOfMaterials] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_BillOfMaterials_UnitMeasureCode] ON [AdvNew2022Restored2].[Production].[BillOfMaterials] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_BillOfMaterials_UnitMeasureCode] ON [AdvNew2022Restored3].[Production].[BillOfMaterials] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_BillOfMaterials_UnitMeasureCode] ON [AdvNewDB2022Portal].[Production].[BillOfMaterials] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_BusinessEntityAddress_AddressID] ON [AdventureWorks].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_BusinessEntityAddress_AddressID] ON [AdventureWorks_20240103030343].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_BusinessEntityAddress_AddressID] ON [AdventureWorks_20240130190806].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_BusinessEntityAddress_AddressID] ON [Advnew2022].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [IX_BusinessEntityAddress_AddressTypeID] ON [AdventureWorks_20240103030343].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_BusinessEntityAddress_AddressTypeID] ON [AdventureWorks_20240130190806].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_BusinessEntityAddress_AddressTypeID] ON [Advnew2022].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [IX_Customer_TerritoryID] ON [AdventureWorks_20240103030343].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_Customer_TerritoryID] ON [AdventureWorks_20240130190806].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_Customer_TerritoryID] ON [Advnew2022].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [IX_EmailAddress_EmailAddress] ON [AdventureWorks_20240103030343].[Person].[EmailAddress] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_EmailAddress_EmailAddress] ON [AdventureWorks_20240130190806].[Person].[EmailAddress] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_EmailAddress_EmailAddress] ON [Advnew2022].[Person].[EmailAddress] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [IX_Person_LastName_FirstName_MiddleName] ON [AdventureWorks_20240103030343].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_Person_LastName_FirstName_MiddleName] ON [AdventureWorks_20240130190806].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_Person_LastName_FirstName_MiddleName] ON [Advnew2022].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [IX_PersonPhone_PhoneNumber] ON [AdventureWorks_20240103030343].[Person].[PersonPhone] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_PersonPhone_PhoneNumber] ON [AdventureWorks_20240130190806].[Person].[PersonPhone] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_PersonPhone_PhoneNumber] ON [Advnew2022].[Person].[PersonPhone] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [IX_PurchaseOrderDetail_ProductID] ON [AdventureWorks_20240103030343].[Purchasing].[PurchaseOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_PurchaseOrderDetail_ProductID] ON [AdventureWorks_20240130190806].[Purchasing].[PurchaseOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_PurchaseOrderDetail_ProductID] ON [Advnew2022].[Purchasing].[PurchaseOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_PurchaseOrderDetail_ProductID] ON [AdvNew2022Restored].[Purchasing].[PurchaseOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_PurchaseOrderDetail_ProductID] ON [AdvNew2022Restored2].[Purchasing].[PurchaseOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_PurchaseOrderDetail_ProductID] ON [AdvNew2022Restored3].[Purchasing].[PurchaseOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_PurchaseOrderDetail_ProductID] ON [AdvNewDB2022Portal].[Purchasing].[PurchaseOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_PurchaseOrderHeader_EmployeeID] ON [AdventureWorks].[Purchasing].[PurchaseOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_PurchaseOrderHeader_EmployeeID] ON [AdventureWorks_20240103030343].[Purchasing].[PurchaseOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_PurchaseOrderHeader_EmployeeID] ON [AdventureWorks_20240130190806].[Purchasing].[PurchaseOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_PurchaseOrderHeader_EmployeeID] ON [Advnew2022].[Purchasing].[PurchaseOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_PurchaseOrderHeader_EmployeeID] ON [AdvNew2022Restored].[Purchasing].[PurchaseOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_PurchaseOrderHeader_EmployeeID] ON [AdvNew2022Restored2].[Purchasing].[PurchaseOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_PurchaseOrderHeader_EmployeeID] ON [AdvNew2022Restored3].[Purchasing].[PurchaseOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_PurchaseOrderHeader_EmployeeID] ON [AdvNewDB2022Portal].[Purchasing].[PurchaseOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_PurchaseOrderHeader_VendorID] ON [AdventureWorks].[Purchasing].[PurchaseOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_PurchaseOrderHeader_VendorID] ON [AdventureWorks_20240103030343].[Purchasing].[PurchaseOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_PurchaseOrderHeader_VendorID] ON [AdventureWorks_20240130190806].[Purchasing].[PurchaseOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_PurchaseOrderHeader_VendorID] ON [Advnew2022].[Purchasing].[PurchaseOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_PurchaseOrderHeader_VendorID] ON [AdvNew2022Restored].[Purchasing].[PurchaseOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_PurchaseOrderHeader_VendorID] ON [AdvNew2022Restored2].[Purchasing].[PurchaseOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_PurchaseOrderHeader_VendorID] ON [AdvNew2022Restored3].[Purchasing].[PurchaseOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_PurchaseOrderHeader_VendorID] ON [AdvNewDB2022Portal].[Purchasing].[PurchaseOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_SalesOrderDetail_ProductID] ON [AdventureWorks].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_SalesOrderDetail_ProductID] ON [AdventureWorks_20240103030343].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_SalesOrderDetail_ProductID] ON [AdventureWorks_20240130190806].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_SalesOrderDetail_ProductID] ON [Advnew2022].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [IX_SalesOrderHeader_CustomerID] ON [AdventureWorks_20240103030343].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_SalesOrderHeader_CustomerID] ON [AdventureWorks_20240130190806].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_SalesOrderHeader_CustomerID] ON [Advnew2022].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [IX_SalesOrderHeader_SalesPersonID] ON [AdventureWorks_20240103030343].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_SalesOrderHeader_SalesPersonID] ON [AdventureWorks_20240130190806].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_SalesOrderHeader_SalesPersonID] ON [Advnew2022].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [IX_TransactionHistory_ProductID] ON [AdventureWorks_20240103030343].[Production].[TransactionHistory] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_TransactionHistory_ProductID] ON [AdventureWorks_20240130190806].[Production].[TransactionHistory] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_TransactionHistory_ProductID] ON [Advnew2022].[Production].[TransactionHistory] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [IX_TransactionHistory_ReferenceOrderID_ReferenceOrderLineID] ON [AdventureWorks_20240103030343].[Production].[TransactionHistory] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_TransactionHistory_ReferenceOrderID_ReferenceOrderLineID] ON [AdventureWorks_20240130190806].[Production].[TransactionHistory] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_TransactionHistory_ReferenceOrderID_ReferenceOrderLineID] ON [Advnew2022].[Production].[TransactionHistory] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [IX_TransactionHistoryArchive_ProductID] ON [AdventureWorks_20240103030343].[Production].[TransactionHistoryArchive] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_TransactionHistoryArchive_ProductID] ON [AdventureWorks_20240130190806].[Production].[TransactionHistoryArchive] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_TransactionHistoryArchive_ProductID] ON [Advnew2022].[Production].[TransactionHistoryArchive] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [IX_TransactionHistoryArchive_ReferenceOrderID_ReferenceOrderLineID] ON [AdventureWorks_20240103030343].[Production].[TransactionHistoryArchive] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_TransactionHistoryArchive_ReferenceOrderID_ReferenceOrderLineID] ON [AdventureWorks_20240130190806].[Production].[TransactionHistoryArchive] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_TransactionHistoryArchive_ReferenceOrderID_ReferenceOrderLineID] ON [Advnew2022].[Production].[TransactionHistoryArchive] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [IX_WorkOrder_ProductID] ON [AdventureWorks_20240103030343].[Production].[WorkOrder] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_WorkOrder_ProductID] ON [AdventureWorks_20240130190806].[Production].[WorkOrder] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_WorkOrder_ProductID] ON [Advnew2022].[Production].[WorkOrder] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [IX_WorkOrder_ScrapReasonID] ON [AdventureWorks_20240103030343].[Production].[WorkOrder] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_WorkOrder_ScrapReasonID] ON [AdventureWorks_20240130190806].[Production].[WorkOrder] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_WorkOrder_ScrapReasonID] ON [Advnew2022].[Production].[WorkOrder] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [IX_WorkOrderRouting_ProductID] ON [AdventureWorks_20240103030343].[Production].[WorkOrderRouting] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_WorkOrderRouting_ProductID] ON [AdventureWorks_20240130190806].[Production].[WorkOrderRouting] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [IX_WorkOrderRouting_ProductID] ON [Advnew2022].[Production].[WorkOrderRouting] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [PK_Address_AddressID] ON [AdventureWorks_20240103030343].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_Address_AddressID] ON [AdventureWorks_20240130190806].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_Address_AddressID] ON [Advnew2022].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [PK_BillOfMaterials_BillOfMaterialsID] ON [AdventureWorks_20240103030343].[Production].[BillOfMaterials] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_BillOfMaterials_BillOfMaterialsID] ON [AdventureWorks_20240130190806].[Production].[BillOfMaterials] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_BillOfMaterials_BillOfMaterialsID] ON [Advnew2022].[Production].[BillOfMaterials] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_BillOfMaterials_BillOfMaterialsID] ON [AdvNew2022Restored].[Production].[BillOfMaterials] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_BillOfMaterials_BillOfMaterialsID] ON [AdvNew2022Restored2].[Production].[BillOfMaterials] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_BillOfMaterials_BillOfMaterialsID] ON [AdvNew2022Restored3].[Production].[BillOfMaterials] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_BillOfMaterials_BillOfMaterialsID] ON [AdvNewDB2022Portal].[Production].[BillOfMaterials] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_BusinessEntity_BusinessEntityID] ON [AdventureWorks].[Person].[BusinessEntity] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_BusinessEntity_BusinessEntityID] ON [AdventureWorks_20240103030343].[Person].[BusinessEntity] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_BusinessEntity_BusinessEntityID] ON [AdventureWorks_20240130190806].[Person].[BusinessEntity] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_BusinessEntity_BusinessEntityID] ON [Advnew2022].[Person].[BusinessEntity] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [PK_BusinessEntityAddress_BusinessEntityID_AddressID_AddressTypeID] ON [AdventureWorks_20240103030343].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_BusinessEntityAddress_BusinessEntityID_AddressID_AddressTypeID] ON [AdventureWorks_20240130190806].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_BusinessEntityAddress_BusinessEntityID_AddressID_AddressTypeID] ON [Advnew2022].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [PK_CreditCard_CreditCardID] ON [AdventureWorks_20240103030343].[Sales].[CreditCard] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_CreditCard_CreditCardID] ON [AdventureWorks_20240130190806].[Sales].[CreditCard] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_CreditCard_CreditCardID] ON [Advnew2022].[Sales].[CreditCard] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [PK_CurrencyRate_CurrencyRateID] ON [AdventureWorks_20240103030343].[Sales].[CurrencyRate] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_CurrencyRate_CurrencyRateID] ON [AdventureWorks_20240130190806].[Sales].[CurrencyRate] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_CurrencyRate_CurrencyRateID] ON [Advnew2022].[Sales].[CurrencyRate] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [PK_Customer_CustomerID] ON [AdventureWorks_20240103030343].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_Customer_CustomerID] ON [AdventureWorks_20240130190806].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_Customer_CustomerID] ON [Advnew2022].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [PK_EmailAddress_BusinessEntityID_EmailAddressID] ON [AdventureWorks_20240103030343].[Person].[EmailAddress] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_EmailAddress_BusinessEntityID_EmailAddressID] ON [AdventureWorks_20240130190806].[Person].[EmailAddress] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_EmailAddress_BusinessEntityID_EmailAddressID] ON [Advnew2022].[Person].[EmailAddress] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [PK_Password_BusinessEntityID] ON [AdventureWorks_20240103030343].[Person].[Password] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_Password_BusinessEntityID] ON [AdventureWorks_20240130190806].[Person].[Password] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_Password_BusinessEntityID] ON [Advnew2022].[Person].[Password] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [PK_Person_BusinessEntityID] ON [AdventureWorks_20240103030343].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_Person_BusinessEntityID] ON [AdventureWorks_20240130190806].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_Person_BusinessEntityID] ON [Advnew2022].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [PK_PersonCreditCard_BusinessEntityID_CreditCardID] ON [AdventureWorks_20240103030343].[Sales].[PersonCreditCard] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_PersonCreditCard_BusinessEntityID_CreditCardID] ON [AdventureWorks_20240130190806].[Sales].[PersonCreditCard] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_PersonCreditCard_BusinessEntityID_CreditCardID] ON [Advnew2022].[Sales].[PersonCreditCard] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [PK_PersonPhone_BusinessEntityID_PhoneNumber_PhoneNumberTypeID] ON [AdventureWorks_20240103030343].[Person].[PersonPhone] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_PersonPhone_BusinessEntityID_PhoneNumber_PhoneNumberTypeID] ON [AdventureWorks_20240130190806].[Person].[PersonPhone] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_PersonPhone_BusinessEntityID_PhoneNumber_PhoneNumberTypeID] ON [Advnew2022].[Person].[PersonPhone] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [PK_ProductInventory_ProductID_LocationID] ON [AdventureWorks_20240103030343].[Production].[ProductInventory] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_ProductInventory_ProductID_LocationID] ON [AdventureWorks_20240130190806].[Production].[ProductInventory] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_ProductInventory_ProductID_LocationID] ON [Advnew2022].[Production].[ProductInventory] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_ProductInventory_ProductID_LocationID] ON [AdvNew2022Restored].[Production].[ProductInventory] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_ProductInventory_ProductID_LocationID] ON [AdvNew2022Restored2].[Production].[ProductInventory] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_ProductInventory_ProductID_LocationID] ON [AdvNew2022Restored3].[Production].[ProductInventory] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_ProductInventory_ProductID_LocationID] ON [AdvNewDB2022Portal].[Production].[ProductInventory] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID] ON [AdventureWorks_20240103030343].[Purchasing].[PurchaseOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID] ON [AdventureWorks_20240130190806].[Purchasing].[PurchaseOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID] ON [Advnew2022].[Purchasing].[PurchaseOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID] ON [AdvNew2022Restored].[Purchasing].[PurchaseOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID] ON [AdvNew2022Restored2].[Purchasing].[PurchaseOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID] ON [AdvNew2022Restored3].[Purchasing].[PurchaseOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID] ON [AdvNewDB2022Portal].[Purchasing].[PurchaseOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [PK_PurchaseOrderHeader_PurchaseOrderID] ON [AdventureWorks_20240103030343].[Purchasing].[PurchaseOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_PurchaseOrderHeader_PurchaseOrderID] ON [AdventureWorks_20240130190806].[Purchasing].[PurchaseOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_PurchaseOrderHeader_PurchaseOrderID] ON [Advnew2022].[Purchasing].[PurchaseOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_PurchaseOrderHeader_PurchaseOrderID] ON [AdvNew2022Restored].[Purchasing].[PurchaseOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_PurchaseOrderHeader_PurchaseOrderID] ON [AdvNew2022Restored2].[Purchasing].[PurchaseOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_PurchaseOrderHeader_PurchaseOrderID] ON [AdvNew2022Restored3].[Purchasing].[PurchaseOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_PurchaseOrderHeader_PurchaseOrderID] ON [AdvNewDB2022Portal].[Purchasing].[PurchaseOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [PK_SalesOrderDetail_SalesOrderID_SalesOrderDetailID] ON [AdventureWorks_20240103030343].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_SalesOrderDetail_SalesOrderID_SalesOrderDetailID] ON [AdventureWorks_20240130190806].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_SalesOrderDetail_SalesOrderID_SalesOrderDetailID] ON [Advnew2022].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [PK_SalesOrderHeader_SalesOrderID] ON [AdventureWorks_20240103030343].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_SalesOrderHeader_SalesOrderID] ON [AdventureWorks_20240130190806].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_SalesOrderHeader_SalesOrderID] ON [Advnew2022].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [PK_SalesOrderHeaderSalesReason_SalesOrderID_SalesReasonID] ON [AdventureWorks_20240103030343].[Sales].[SalesOrderHeaderSalesReason] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_SalesOrderHeaderSalesReason_SalesOrderID_SalesReasonID] ON [AdventureWorks_20240130190806].[Sales].[SalesOrderHeaderSalesReason] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_SalesOrderHeaderSalesReason_SalesOrderID_SalesReasonID] ON [Advnew2022].[Sales].[SalesOrderHeaderSalesReason] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [PK_TransactionHistory_TransactionID] ON [AdventureWorks_20240103030343].[Production].[TransactionHistory] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_TransactionHistory_TransactionID] ON [AdventureWorks_20240130190806].[Production].[TransactionHistory] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_TransactionHistory_TransactionID] ON [Advnew2022].[Production].[TransactionHistory] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [PK_TransactionHistoryArchive_TransactionID] ON [AdventureWorks_20240103030343].[Production].[TransactionHistoryArchive] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_TransactionHistoryArchive_TransactionID] ON [AdventureWorks_20240130190806].[Production].[TransactionHistoryArchive] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_TransactionHistoryArchive_TransactionID] ON [Advnew2022].[Production].[TransactionHistoryArchive] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [PK_WorkOrder_WorkOrderID] ON [AdventureWorks_20240103030343].[Production].[WorkOrder] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_WorkOrder_WorkOrderID] ON [AdventureWorks_20240130190806].[Production].[WorkOrder] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_WorkOrder_WorkOrderID] ON [Advnew2022].[Production].[WorkOrder] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [PK_WorkOrderRouting_WorkOrderID_ProductID_OperationSequence] ON [AdventureWorks_20240103030343].[Production].[WorkOrderRouting] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_WorkOrderRouting_WorkOrderID_ProductID_OperationSequence] ON [AdventureWorks_20240130190806].[Production].[WorkOrderRouting] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PK_WorkOrderRouting_WorkOrderID_ProductID_OperationSequence] ON [Advnew2022].[Production].[WorkOrderRouting] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [PXML_Person_AddContact] ON [AdventureWorks_20240103030343].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PXML_Person_AddContact] ON [AdventureWorks_20240130190806].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PXML_Person_AddContact] ON [Advnew2022].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [PXML_Person_Demographics] ON [AdventureWorks_20240103030343].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PXML_Person_Demographics] ON [AdventureWorks_20240130190806].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [PXML_Person_Demographics] ON [Advnew2022].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [XMLPATH_Person_Demographics] ON [AdventureWorks_20240103030343].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [XMLPATH_Person_Demographics] ON [AdventureWorks_20240130190806].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [XMLPATH_Person_Demographics] ON [Advnew2022].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [XMLPROPERTY_Person_Demographics] ON [AdventureWorks_20240103030343].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [XMLPROPERTY_Person_Demographics] ON [AdventureWorks_20240130190806].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [XMLPROPERTY_Person_Demographics] ON [Advnew2022].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
		...
		ALTER INDEX [XMLVALUE_Person_Demographics] ON [AdventureWorks_20240103030343].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [XMLVALUE_Person_Demographics] ON [AdventureWorks_20240130190806].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
		ALTER INDEX [XMLVALUE_Person_Demographics] ON [Advnew2022].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
