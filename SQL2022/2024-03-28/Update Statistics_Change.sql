...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [Advnew2022_20240312102058].sys.stats S CROSS APPLY [Advnew2022_20240312102058].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000002_4E88ABD4' AND OBJECT_NAME(S.OBJECT_ID) = 'Customer' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [Advnew2022_20240312102058].[Sales].[Customer] [_WA_Sys_00000002_4E88ABD4] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000002_4E88ABD4] on [Advnew2022_20240312102058].[Sales].[Customer] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000002_4E88ABD4] on [Advnew2022_20240312102058].[Sales].[Customer] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [Advnew2022_20240312102058].sys.stats S CROSS APPLY [Advnew2022_20240312102058].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = '_WA_Sys_00000003_4E88ABD4' AND OBJECT_NAME(S.OBJECT_ID) = 'Customer' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [Advnew2022_20240312102058].[Sales].[Customer] [_WA_Sys_00000003_4E88ABD4] WITH FULLSCAN ;
		END
		PRINT '[_WA_Sys_00000003_4E88ABD4] on [Advnew2022_20240312102058].[Sales].[Customer] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[_WA_Sys_00000003_4E88ABD4] on [Advnew2022_20240312102058].[Sales].[Customer] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [Advnew2022_20240312102058].sys.stats S CROSS APPLY [Advnew2022_20240312102058].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'AK_Customer_AccountNumber' AND OBJECT_NAME(S.OBJECT_ID) = 'Customer' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [Advnew2022_20240312102058].[Sales].[Customer] [AK_Customer_AccountNumber] WITH FULLSCAN ;
		END
		PRINT '[AK_Customer_AccountNumber] on [Advnew2022_20240312102058].[Sales].[Customer] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[AK_Customer_AccountNumber] on [Advnew2022_20240312102058].[Sales].[Customer] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [Advnew2022_20240312102058].sys.stats S CROSS APPLY [Advnew2022_20240312102058].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'AK_Customer_rowguid' AND OBJECT_NAME(S.OBJECT_ID) = 'Customer' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [Advnew2022_20240312102058].[Sales].[Customer] [AK_Customer_rowguid] WITH FULLSCAN ;
		END
		PRINT '[AK_Customer_rowguid] on [Advnew2022_20240312102058].[Sales].[Customer] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[AK_Customer_rowguid] on [Advnew2022_20240312102058].[Sales].[Customer] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [Advnew2022_20240312102058].sys.stats S CROSS APPLY [Advnew2022_20240312102058].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'IX_Customer_TerritoryID' AND OBJECT_NAME(S.OBJECT_ID) = 'Customer' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [Advnew2022_20240312102058].[Sales].[Customer] [IX_Customer_TerritoryID] WITH FULLSCAN ;
		END
		PRINT '[IX_Customer_TerritoryID] on [Advnew2022_20240312102058].[Sales].[Customer] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[IX_Customer_TerritoryID] on [Advnew2022_20240312102058].[Sales].[Customer] cannot be updated.';			
	END CATCH;
END
...
BEGIN
	BEGIN TRY
		IF EXISTS (SELECT 1 FROM [Advnew2022_20240312102058].sys.stats S CROSS APPLY [Advnew2022_20240312102058].sys.dm_db_stats_properties(S.object_id,S.stats_id) P WHERE S.NAME = 'PK_Customer_CustomerID' AND OBJECT_NAME(S.OBJECT_ID) = 'Customer' AND P.last_updated <= DATEADD(HOUR,-48,SYSDATETIME()))
		BEGIN
			UPDATE STATISTICS [Advnew2022_20240312102058].[Sales].[Customer] [PK_Customer_CustomerID] WITH FULLSCAN ;
		END
		PRINT '[PK_Customer_CustomerID] on [Advnew2022_20240312102058].[Sales].[Customer] is updated.';
	END TRY
	BEGIN CATCH
		PRINT '[PK_Customer_CustomerID] on [Advnew2022_20240312102058].[Sales].[Customer] cannot be updated.';			
	END CATCH;
END
