	...
	IF DB_ID('AdvDest20240317') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_AIDBA_1_20250715] ON [AdvDest20240317].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvDest20240317') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_AIDBA_2_20250715] ON [AdvDest20240317].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvDest20240317') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_AIDBA_3_20250715] ON [AdvDest20240317].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvDest20240317') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_AIDBA_4_20250715] ON [AdvDest20240317].[Production].[WorkOrderRouting] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_AIDBA_1_20250624] ON [AdventureWorks].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_AIDBA_2_20250506] ON [AdventureWorks].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	BEGIN
		ALTER INDEX [AK_Address_rowguid] ON [advnew2019].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_BusinessEntity_rowguid] ON [advnew2019].[Person].[BusinessEntity] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_BusinessEntityAddress_rowguid] ON [advnew2019].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_CreditCard_CardNumber] ON [advnew2019].[Sales].[CreditCard] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_CurrencyRate_CurrencyRateDate_FromCurrencyCode_ToCurrencyCode] ON [advnew2019].[Sales].[CurrencyRate] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_Customer_AccountNumber] ON [advnew2019].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_Customer_rowguid] ON [advnew2019].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_Person_rowguid] ON [advnew2019].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_SalesOrderDetail_rowguid] ON [advnew2019].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_SalesOrderHeader_rowguid] ON [advnew2019].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_SalesOrderHeader_SalesOrderNumber] ON [advnew2019].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_Address_AddressLine1_AddressLine2_City_StateProvinceID_PostalCode] ON [advnew2019].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_Address_StateProvinceID] ON [advnew2019].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_BusinessEntityAddress_AddressID] ON [advnew2019].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_BusinessEntityAddress_AddressTypeID] ON [advnew2019].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_Customer_TerritoryID] ON [advnew2019].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_EmailAddress_EmailAddress] ON [advnew2019].[Person].[EmailAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_Person_LastName_FirstName_MiddleName] ON [advnew2019].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_PersonPhone_PhoneNumber] ON [advnew2019].[Person].[PersonPhone] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_SalesOrderDetail_ProductID] ON [advnew2019].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_SalesOrderHeader_CustomerID] ON [advnew2019].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_SalesOrderHeader_SalesPersonID] ON [advnew2019].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_TransactionHistory_ProductID] ON [advnew2019].[Production].[TransactionHistory] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_TransactionHistory_ReferenceOrderID_ReferenceOrderLineID] ON [advnew2019].[Production].[TransactionHistory] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_TransactionHistoryArchive_ProductID] ON [advnew2019].[Production].[TransactionHistoryArchive] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_TransactionHistoryArchive_ReferenceOrderID_ReferenceOrderLineID] ON [advnew2019].[Production].[TransactionHistoryArchive] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_WorkOrder_ProductID] ON [advnew2019].[Production].[WorkOrder] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_WorkOrder_ScrapReasonID] ON [advnew2019].[Production].[WorkOrder] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_WorkOrderRouting_ProductID] ON [advnew2019].[Production].[WorkOrderRouting] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_Address_AddressID] ON [advnew2019].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_BusinessEntity_BusinessEntityID] ON [advnew2019].[Person].[BusinessEntity] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_BusinessEntityAddress_BusinessEntityID_AddressID_AddressTypeID] ON [advnew2019].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_CreditCard_CreditCardID] ON [advnew2019].[Sales].[CreditCard] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_CurrencyRate_CurrencyRateID] ON [advnew2019].[Sales].[CurrencyRate] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_Customer_CustomerID] ON [advnew2019].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_EmailAddress_BusinessEntityID_EmailAddressID] ON [advnew2019].[Person].[EmailAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_Password_BusinessEntityID] ON [advnew2019].[Person].[Password] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_Person_BusinessEntityID] ON [advnew2019].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_PersonCreditCard_BusinessEntityID_CreditCardID] ON [advnew2019].[Sales].[PersonCreditCard] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_PersonPhone_BusinessEntityID_PhoneNumber_PhoneNumberTypeID] ON [advnew2019].[Person].[PersonPhone] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_SalesOrderDetail_SalesOrderID_SalesOrderDetailID] ON [advnew2019].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_SalesOrderHeader_SalesOrderID] ON [advnew2019].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_SalesOrderHeaderSalesReason_SalesOrderID_SalesReasonID] ON [advnew2019].[Sales].[SalesOrderHeaderSalesReason] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_TransactionHistory_TransactionID] ON [advnew2019].[Production].[TransactionHistory] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_TransactionHistoryArchive_TransactionID] ON [advnew2019].[Production].[TransactionHistoryArchive] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_WorkOrder_WorkOrderID] ON [advnew2019].[Production].[WorkOrder] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_WorkOrderRouting_WorkOrderID_ProductID_OperationSequence] ON [advnew2019].[Production].[WorkOrderRouting] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [PXML_Person_AddContact] ON [advnew2019].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [PXML_Person_Demographics] ON [advnew2019].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [XMLPATH_Person_Demographics] ON [advnew2019].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [XMLPROPERTY_Person_Demographics] ON [advnew2019].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('advnew2019') IS NOT NULL
	BEGIN
		ALTER INDEX [XMLVALUE_Person_Demographics] ON [advnew2019].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	BEGIN
		ALTER INDEX [AK_Address_rowguid] ON [AdvNewDB2].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_BusinessEntity_rowguid] ON [AdvNewDB2].[Person].[BusinessEntity] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_BusinessEntityAddress_rowguid] ON [AdvNewDB2].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_CreditCard_CardNumber] ON [AdvNewDB2].[Sales].[CreditCard] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_CurrencyRate_CurrencyRateDate_FromCurrencyCode_ToCurrencyCode] ON [AdvNewDB2].[Sales].[CurrencyRate] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_Customer_AccountNumber] ON [AdvNewDB2].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_Customer_rowguid] ON [AdvNewDB2].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_Person_rowguid] ON [AdvNewDB2].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_SalesOrderDetail_rowguid] ON [AdvNewDB2].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_SalesOrderHeader_rowguid] ON [AdvNewDB2].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_SalesOrderHeader_SalesOrderNumber] ON [AdvNewDB2].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_Address_AddressLine1_AddressLine2_City_StateProvinceID_PostalCode] ON [AdvNewDB2].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_Address_StateProvinceID] ON [AdvNewDB2].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_BusinessEntityAddress_AddressID] ON [AdvNewDB2].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_BusinessEntityAddress_AddressTypeID] ON [AdvNewDB2].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_Customer_TerritoryID] ON [AdvNewDB2].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_EmailAddress_EmailAddress] ON [AdvNewDB2].[Person].[EmailAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_Person_LastName_FirstName_MiddleName] ON [AdvNewDB2].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_PersonPhone_PhoneNumber] ON [AdvNewDB2].[Person].[PersonPhone] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_SalesOrderDetail_ProductID] ON [AdvNewDB2].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_SalesOrderHeader_CustomerID] ON [AdvNewDB2].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_SalesOrderHeader_SalesPersonID] ON [AdvNewDB2].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_TransactionHistory_ProductID] ON [AdvNewDB2].[Production].[TransactionHistory] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_TransactionHistory_ReferenceOrderID_ReferenceOrderLineID] ON [AdvNewDB2].[Production].[TransactionHistory] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_TransactionHistoryArchive_ProductID] ON [AdvNewDB2].[Production].[TransactionHistoryArchive] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_TransactionHistoryArchive_ReferenceOrderID_ReferenceOrderLineID] ON [AdvNewDB2].[Production].[TransactionHistoryArchive] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_WorkOrder_ProductID] ON [AdvNewDB2].[Production].[WorkOrder] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_WorkOrder_ScrapReasonID] ON [AdvNewDB2].[Production].[WorkOrder] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_WorkOrderRouting_ProductID] ON [AdvNewDB2].[Production].[WorkOrderRouting] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_Address_AddressID] ON [AdvNewDB2].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_BusinessEntity_BusinessEntityID] ON [AdvNewDB2].[Person].[BusinessEntity] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_BusinessEntityAddress_BusinessEntityID_AddressID_AddressTypeID] ON [AdvNewDB2].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_CreditCard_CreditCardID] ON [AdvNewDB2].[Sales].[CreditCard] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_CurrencyRate_CurrencyRateID] ON [AdvNewDB2].[Sales].[CurrencyRate] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_Customer_CustomerID] ON [AdvNewDB2].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_EmailAddress_BusinessEntityID_EmailAddressID] ON [AdvNewDB2].[Person].[EmailAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_Password_BusinessEntityID] ON [AdvNewDB2].[Person].[Password] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_Person_BusinessEntityID] ON [AdvNewDB2].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_PersonCreditCard_BusinessEntityID_CreditCardID] ON [AdvNewDB2].[Sales].[PersonCreditCard] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_PersonPhone_BusinessEntityID_PhoneNumber_PhoneNumberTypeID] ON [AdvNewDB2].[Person].[PersonPhone] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_SalesOrderDetail_SalesOrderID_SalesOrderDetailID] ON [AdvNewDB2].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_SalesOrderHeader_SalesOrderID] ON [AdvNewDB2].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_SalesOrderHeaderSalesReason_SalesOrderID_SalesReasonID] ON [AdvNewDB2].[Sales].[SalesOrderHeaderSalesReason] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_TransactionHistory_TransactionID] ON [AdvNewDB2].[Production].[TransactionHistory] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_TransactionHistoryArchive_TransactionID] ON [AdvNewDB2].[Production].[TransactionHistoryArchive] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_WorkOrder_WorkOrderID] ON [AdvNewDB2].[Production].[WorkOrder] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_WorkOrderRouting_WorkOrderID_ProductID_OperationSequence] ON [AdvNewDB2].[Production].[WorkOrderRouting] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [PXML_Person_AddContact] ON [AdvNewDB2].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [PXML_Person_Demographics] ON [AdvNewDB2].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [XMLPATH_Person_Demographics] ON [AdvNewDB2].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [XMLPROPERTY_Person_Demographics] ON [AdvNewDB2].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AdvNewDB2') IS NOT NULL
	BEGIN
		ALTER INDEX [XMLVALUE_Person_Demographics] ON [AdvNewDB2].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	BEGIN
		ALTER INDEX [AK_Address_rowguid] ON [AZUREADVWORKS2017].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_BusinessEntity_rowguid] ON [AZUREADVWORKS2017].[Person].[BusinessEntity] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_BusinessEntityAddress_rowguid] ON [AZUREADVWORKS2017].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_CreditCard_CardNumber] ON [AZUREADVWORKS2017].[Sales].[CreditCard] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_CurrencyRate_CurrencyRateDate_FromCurrencyCode_ToCurrencyCode] ON [AZUREADVWORKS2017].[Sales].[CurrencyRate] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_Customer_AccountNumber] ON [AZUREADVWORKS2017].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_Customer_rowguid] ON [AZUREADVWORKS2017].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_Person_rowguid] ON [AZUREADVWORKS2017].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_SalesOrderDetail_rowguid] ON [AZUREADVWORKS2017].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_SalesOrderHeader_rowguid] ON [AZUREADVWORKS2017].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_SalesOrderHeader_SalesOrderNumber] ON [AZUREADVWORKS2017].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_Address_AddressLine1_AddressLine2_City_StateProvinceID_PostalCode] ON [AZUREADVWORKS2017].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_Address_StateProvinceID] ON [AZUREADVWORKS2017].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_BusinessEntityAddress_AddressID] ON [AZUREADVWORKS2017].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_BusinessEntityAddress_AddressTypeID] ON [AZUREADVWORKS2017].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_Customer_TerritoryID] ON [AZUREADVWORKS2017].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_EmailAddress_EmailAddress] ON [AZUREADVWORKS2017].[Person].[EmailAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_Person_LastName_FirstName_MiddleName] ON [AZUREADVWORKS2017].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_PersonPhone_PhoneNumber] ON [AZUREADVWORKS2017].[Person].[PersonPhone] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_SalesOrderDetail_ProductID] ON [AZUREADVWORKS2017].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_SalesOrderHeader_CustomerID] ON [AZUREADVWORKS2017].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_SalesOrderHeader_SalesPersonID] ON [AZUREADVWORKS2017].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_TransactionHistory_ProductID] ON [AZUREADVWORKS2017].[Production].[TransactionHistory] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_TransactionHistory_ReferenceOrderID_ReferenceOrderLineID] ON [AZUREADVWORKS2017].[Production].[TransactionHistory] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_TransactionHistoryArchive_ProductID] ON [AZUREADVWORKS2017].[Production].[TransactionHistoryArchive] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_TransactionHistoryArchive_ReferenceOrderID_ReferenceOrderLineID] ON [AZUREADVWORKS2017].[Production].[TransactionHistoryArchive] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_WorkOrder_ProductID] ON [AZUREADVWORKS2017].[Production].[WorkOrder] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_WorkOrder_ScrapReasonID] ON [AZUREADVWORKS2017].[Production].[WorkOrder] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_WorkOrderRouting_ProductID] ON [AZUREADVWORKS2017].[Production].[WorkOrderRouting] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_Address_AddressID] ON [AZUREADVWORKS2017].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_BusinessEntity_BusinessEntityID] ON [AZUREADVWORKS2017].[Person].[BusinessEntity] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_BusinessEntityAddress_BusinessEntityID_AddressID_AddressTypeID] ON [AZUREADVWORKS2017].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_CreditCard_CreditCardID] ON [AZUREADVWORKS2017].[Sales].[CreditCard] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_CurrencyRate_CurrencyRateID] ON [AZUREADVWORKS2017].[Sales].[CurrencyRate] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_Customer_CustomerID] ON [AZUREADVWORKS2017].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_EmailAddress_BusinessEntityID_EmailAddressID] ON [AZUREADVWORKS2017].[Person].[EmailAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_Password_BusinessEntityID] ON [AZUREADVWORKS2017].[Person].[Password] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_Person_BusinessEntityID] ON [AZUREADVWORKS2017].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_PersonCreditCard_BusinessEntityID_CreditCardID] ON [AZUREADVWORKS2017].[Sales].[PersonCreditCard] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_PersonPhone_BusinessEntityID_PhoneNumber_PhoneNumberTypeID] ON [AZUREADVWORKS2017].[Person].[PersonPhone] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_SalesOrderDetail_SalesOrderID_SalesOrderDetailID] ON [AZUREADVWORKS2017].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_SalesOrderHeader_SalesOrderID] ON [AZUREADVWORKS2017].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_SalesOrderHeaderSalesReason_SalesOrderID_SalesReasonID] ON [AZUREADVWORKS2017].[Sales].[SalesOrderHeaderSalesReason] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_TransactionHistory_TransactionID] ON [AZUREADVWORKS2017].[Production].[TransactionHistory] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_TransactionHistoryArchive_TransactionID] ON [AZUREADVWORKS2017].[Production].[TransactionHistoryArchive] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_WorkOrder_WorkOrderID] ON [AZUREADVWORKS2017].[Production].[WorkOrder] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_WorkOrderRouting_WorkOrderID_ProductID_OperationSequence] ON [AZUREADVWORKS2017].[Production].[WorkOrderRouting] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [PXML_Person_AddContact] ON [AZUREADVWORKS2017].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [PXML_Person_Demographics] ON [AZUREADVWORKS2017].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [XMLPATH_Person_Demographics] ON [AZUREADVWORKS2017].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [XMLPROPERTY_Person_Demographics] ON [AZUREADVWORKS2017].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('AZUREADVWORKS2017') IS NOT NULL
	BEGIN
		ALTER INDEX [XMLVALUE_Person_Demographics] ON [AZUREADVWORKS2017].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	BEGIN
		ALTER INDEX [AK_Address_rowguid] ON [NewAdventureWorks].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_BusinessEntity_rowguid] ON [NewAdventureWorks].[Person].[BusinessEntity] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_BusinessEntityAddress_rowguid] ON [NewAdventureWorks].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_CreditCard_CardNumber] ON [NewAdventureWorks].[Sales].[CreditCard] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_CurrencyRate_CurrencyRateDate_FromCurrencyCode_ToCurrencyCode] ON [NewAdventureWorks].[Sales].[CurrencyRate] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_Customer_AccountNumber] ON [NewAdventureWorks].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_Customer_rowguid] ON [NewAdventureWorks].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_Person_rowguid] ON [NewAdventureWorks].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_SalesOrderDetail_rowguid] ON [NewAdventureWorks].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_SalesOrderHeader_rowguid] ON [NewAdventureWorks].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_SalesOrderHeader_SalesOrderNumber] ON [NewAdventureWorks].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_Address_AddressLine1_AddressLine2_City_StateProvinceID_PostalCode] ON [NewAdventureWorks].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_Address_StateProvinceID] ON [NewAdventureWorks].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_BusinessEntityAddress_AddressID] ON [NewAdventureWorks].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_BusinessEntityAddress_AddressTypeID] ON [NewAdventureWorks].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_Customer_TerritoryID] ON [NewAdventureWorks].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_EmailAddress_EmailAddress] ON [NewAdventureWorks].[Person].[EmailAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_Person_LastName_FirstName_MiddleName] ON [NewAdventureWorks].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_PersonPhone_PhoneNumber] ON [NewAdventureWorks].[Person].[PersonPhone] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_SalesOrderDetail_ProductID] ON [NewAdventureWorks].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_SalesOrderHeader_CustomerID] ON [NewAdventureWorks].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_SalesOrderHeader_SalesPersonID] ON [NewAdventureWorks].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_TransactionHistory_ProductID] ON [NewAdventureWorks].[Production].[TransactionHistory] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_TransactionHistory_ReferenceOrderID_ReferenceOrderLineID] ON [NewAdventureWorks].[Production].[TransactionHistory] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_TransactionHistoryArchive_ProductID] ON [NewAdventureWorks].[Production].[TransactionHistoryArchive] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_TransactionHistoryArchive_ReferenceOrderID_ReferenceOrderLineID] ON [NewAdventureWorks].[Production].[TransactionHistoryArchive] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_WorkOrder_ProductID] ON [NewAdventureWorks].[Production].[WorkOrder] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_WorkOrder_ScrapReasonID] ON [NewAdventureWorks].[Production].[WorkOrder] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_WorkOrderRouting_ProductID] ON [NewAdventureWorks].[Production].[WorkOrderRouting] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_Address_AddressID] ON [NewAdventureWorks].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_BusinessEntity_BusinessEntityID] ON [NewAdventureWorks].[Person].[BusinessEntity] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_BusinessEntityAddress_BusinessEntityID_AddressID_AddressTypeID] ON [NewAdventureWorks].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_CreditCard_CreditCardID] ON [NewAdventureWorks].[Sales].[CreditCard] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_CurrencyRate_CurrencyRateID] ON [NewAdventureWorks].[Sales].[CurrencyRate] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_Customer_CustomerID] ON [NewAdventureWorks].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_EmailAddress_BusinessEntityID_EmailAddressID] ON [NewAdventureWorks].[Person].[EmailAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_Password_BusinessEntityID] ON [NewAdventureWorks].[Person].[Password] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_Person_BusinessEntityID] ON [NewAdventureWorks].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_PersonCreditCard_BusinessEntityID_CreditCardID] ON [NewAdventureWorks].[Sales].[PersonCreditCard] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_PersonPhone_BusinessEntityID_PhoneNumber_PhoneNumberTypeID] ON [NewAdventureWorks].[Person].[PersonPhone] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_SalesOrderDetail_SalesOrderID_SalesOrderDetailID] ON [NewAdventureWorks].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_SalesOrderHeader_SalesOrderID] ON [NewAdventureWorks].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_SalesOrderHeaderSalesReason_SalesOrderID_SalesReasonID] ON [NewAdventureWorks].[Sales].[SalesOrderHeaderSalesReason] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_TransactionHistory_TransactionID] ON [NewAdventureWorks].[Production].[TransactionHistory] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_TransactionHistoryArchive_TransactionID] ON [NewAdventureWorks].[Production].[TransactionHistoryArchive] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_WorkOrder_WorkOrderID] ON [NewAdventureWorks].[Production].[WorkOrder] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_WorkOrderRouting_WorkOrderID_ProductID_OperationSequence] ON [NewAdventureWorks].[Production].[WorkOrderRouting] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [PXML_Person_AddContact] ON [NewAdventureWorks].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [PXML_Person_Demographics] ON [NewAdventureWorks].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [XMLPATH_Person_Demographics] ON [NewAdventureWorks].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [XMLPROPERTY_Person_Demographics] ON [NewAdventureWorks].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('NewAdventureWorks') IS NOT NULL
	BEGIN
		ALTER INDEX [XMLVALUE_Person_Demographics] ON [NewAdventureWorks].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	BEGIN
		ALTER INDEX [AK_Address_rowguid] ON [test55666].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_BusinessEntity_rowguid] ON [test55666].[Person].[BusinessEntity] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_BusinessEntityAddress_rowguid] ON [test55666].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_CreditCard_CardNumber] ON [test55666].[Sales].[CreditCard] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_CurrencyRate_CurrencyRateDate_FromCurrencyCode_ToCurrencyCode] ON [test55666].[Sales].[CurrencyRate] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_Customer_AccountNumber] ON [test55666].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_Customer_rowguid] ON [test55666].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_Person_rowguid] ON [test55666].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_SalesOrderDetail_rowguid] ON [test55666].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_SalesOrderHeader_rowguid] ON [test55666].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [AK_SalesOrderHeader_SalesOrderNumber] ON [test55666].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_Address_AddressLine1_AddressLine2_City_StateProvinceID_PostalCode] ON [test55666].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_Address_StateProvinceID] ON [test55666].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_BusinessEntityAddress_AddressID] ON [test55666].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_BusinessEntityAddress_AddressTypeID] ON [test55666].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_Customer_TerritoryID] ON [test55666].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_EmailAddress_EmailAddress] ON [test55666].[Person].[EmailAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_Person_LastName_FirstName_MiddleName] ON [test55666].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_PersonPhone_PhoneNumber] ON [test55666].[Person].[PersonPhone] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_SalesOrderDetail_ProductID] ON [test55666].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_SalesOrderHeader_CustomerID] ON [test55666].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_SalesOrderHeader_SalesPersonID] ON [test55666].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_TransactionHistory_ProductID] ON [test55666].[Production].[TransactionHistory] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_TransactionHistory_ReferenceOrderID_ReferenceOrderLineID] ON [test55666].[Production].[TransactionHistory] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_TransactionHistoryArchive_ProductID] ON [test55666].[Production].[TransactionHistoryArchive] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_TransactionHistoryArchive_ReferenceOrderID_ReferenceOrderLineID] ON [test55666].[Production].[TransactionHistoryArchive] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_WorkOrder_ProductID] ON [test55666].[Production].[WorkOrder] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_WorkOrder_ScrapReasonID] ON [test55666].[Production].[WorkOrder] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [IX_WorkOrderRouting_ProductID] ON [test55666].[Production].[WorkOrderRouting] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_Address_AddressID] ON [test55666].[Person].[Address] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_BusinessEntity_BusinessEntityID] ON [test55666].[Person].[BusinessEntity] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_BusinessEntityAddress_BusinessEntityID_AddressID_AddressTypeID] ON [test55666].[Person].[BusinessEntityAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_CreditCard_CreditCardID] ON [test55666].[Sales].[CreditCard] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_CurrencyRate_CurrencyRateID] ON [test55666].[Sales].[CurrencyRate] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_Customer_CustomerID] ON [test55666].[Sales].[Customer] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_EmailAddress_BusinessEntityID_EmailAddressID] ON [test55666].[Person].[EmailAddress] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_Password_BusinessEntityID] ON [test55666].[Person].[Password] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_Person_BusinessEntityID] ON [test55666].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_PersonCreditCard_BusinessEntityID_CreditCardID] ON [test55666].[Sales].[PersonCreditCard] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_PersonPhone_BusinessEntityID_PhoneNumber_PhoneNumberTypeID] ON [test55666].[Person].[PersonPhone] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_SalesOrderDetail_SalesOrderID_SalesOrderDetailID] ON [test55666].[Sales].[SalesOrderDetail] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_SalesOrderHeader_SalesOrderID] ON [test55666].[Sales].[SalesOrderHeader] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_SalesOrderHeaderSalesReason_SalesOrderID_SalesReasonID] ON [test55666].[Sales].[SalesOrderHeaderSalesReason] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_TransactionHistory_TransactionID] ON [test55666].[Production].[TransactionHistory] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_TransactionHistoryArchive_TransactionID] ON [test55666].[Production].[TransactionHistoryArchive] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_WorkOrder_WorkOrderID] ON [test55666].[Production].[WorkOrder] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [PK_WorkOrderRouting_WorkOrderID_ProductID_OperationSequence] ON [test55666].[Production].[WorkOrderRouting] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [PXML_Person_AddContact] ON [test55666].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [PXML_Person_Demographics] ON [test55666].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [XMLPATH_Person_Demographics] ON [test55666].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [XMLPROPERTY_Person_Demographics] ON [test55666].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
	...
	IF DB_ID('test55666') IS NOT NULL
	BEGIN
		ALTER INDEX [XMLVALUE_Person_Demographics] ON [test55666].[Person].[Person] SET (ALLOW_PAGE_LOCKS = OFF);
	END
	--GO;
